...
urlpatterns = router.urls + [
    ...
    path("settlements/batches", liqv.BatchListView.as_view(), name="v2-settlement-batches"),
    path("settlements/batches/<int:pk>", liqv.BatchDetailView.as_view(), name="v2-settlement-batch"),
    path("settlements/batches/<int:pk>/pay", liqv.BatchPayView.as_view(), name="v2-settlement-batch-pay"),
    path("settlements/batches/<int:pk>/void", liqv.BatchVoidView.as_view(), name="v2-settlement-batch-void"),
    ...
    path("portal/carrier/payout", portal.CarrierPayoutView.as_view(), name="v2-portal-carrier-payout"),
