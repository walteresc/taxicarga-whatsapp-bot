...
- Piso 1 implica acceso NOT_APPLICABLE. En pisos superiores, acceso solo ascensor o escaleras.
...
- updates contiene solo datos nuevos explícitos. corrections contiene solo sobrescrituras explícitamente corregidas.
- Campos permitidos: origin_district, destination_district, origin_floor, destination_floor, origin_access, destination_access, items.
...
REPAIR_PROMPT = """Tu salida anterior violó contrato mecánico. Corrige JSON conservando intención y respuesta natural. No inventes datos. Error: {error}"""
