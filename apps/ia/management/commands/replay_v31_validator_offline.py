...
from apps.ia.v31_blind_holdout_round9 import v31_blind_holdout_round9_cases
from apps.ia.v31_blind_holdout_round10 import v31_blind_holdout_round10_cases
...
class Command(BaseCommand):
    ...
    def handle(self,*args,**options):
        ...
        source_cases=(v31_blind_holdout_cases() if prefix == "h31" else
                      ...
                      v31_blind_holdout_round9_cases() if prefix == "h39" else
                      v31_blind_holdout_round10_cases() if prefix == "h40" else
