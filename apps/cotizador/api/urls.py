...
urlpatterns = [
    ...
    path("pipeline/bookings/<int:pk>/billing", views.BookingBillingView.as_view(), name="v2-booking-billing"),
    path("billing/presets", views.BillingPresetsView.as_view(), name="v2-billing-presets"),
    path("billing/settings", views.BillingSettingsView.as_view(), name="v2-billing-settings"),
