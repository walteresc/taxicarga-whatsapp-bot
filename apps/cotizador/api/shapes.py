...
def lead_summary(lead):
    ...
    return {
        ...
        "loadMode": lead.modo_carga if lead.es_interprovincial else None,
        ...
        "proposedPrice": float(lead.precio_propuesto_cliente) if lead.precio_propuesto_cliente is not None else None,
        "priceNegotiable": lead.precio_propuesto_negociable,
...
def booking_item(servicio):
    ...
    return {
        ...
        "loadMode": servicio.modo_carga if servicio.es_interprovincial else None,
